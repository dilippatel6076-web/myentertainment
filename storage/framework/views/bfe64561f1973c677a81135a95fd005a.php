<aside class="admin-sidebar" id="admin-sidebar">
            <div class="sidebar-content">
                <nav class="sidebar-nav">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/movies')); ?>">
                                <i class="bi bi-graph-up"></i>
                                <span>Movies</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/artist_list')); ?>">
                                <i class="bi bi-people"></i>
                                <span>Artists</span>
                            </a>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/biodata')); ?>">
                                <i class="bi bi-box"></i>
                                <span>Products</span>
                            </a>
                        </li>
        ...
        </aside><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/MyEntertainment/resources/views/partials/navbar.blade.php ENDPATH**/ ?>